...
// Source: github.com/AnomalyFi/hypersdk/state (interfaces: View)
//
// Generated by this command:
//
//	mockgen -package=state -destination=state/mock_view.go github.com/AnomalyFi/hypersdk/state View
//
