...
// Source: github.com/AnomalyFi/hypersdk/state (interfaces: Immutable)
//
// Generated by this command:
//
//	mockgen -package=state -destination=state/mock_immutable.go github.com/AnomalyFi/hypersdk/state Immutable
//
