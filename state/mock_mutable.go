...
// Source: github.com/AnomalyFi/hypersdk/state (interfaces: Mutable)
//
// Generated by this command:
//
//	mockgen -package=state -destination=state/mock_mutable.go github.com/AnomalyFi/hypersdk/state Mutable
//
